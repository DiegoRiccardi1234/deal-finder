...
html += '<a class="hero-cta-primary" href="/2_Tool">Cerca un prodotto \u2192</a>'
html += '<a class="hero-cta-secondary" href="#come-funziona">Scopri come funziona</a>'
html += '</div>'
html += '</div>'
...
how_html += '<a class="hero-cta-primary" href="/2_Tool">Apri il Tool \u2192</a>'
how_html += '</div>'
how_html += '</div>'
